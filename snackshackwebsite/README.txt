...
Tab layout consisting of three buttons
Initial render of main page
Three buttons showing visual press to act as tabs
Function to serve a file when a tab is clicked
Function to render html and css 
Functon to clear or delete served content
